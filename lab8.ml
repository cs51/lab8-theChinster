...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let curr_id = new_id () in
    evt := {id = curr_id; action = listener} :: !evt; curr_id
...
let receive_report (s : string) : unit =
  WEvent.add_listener publish (fun x -> fakeNewsNetwork s);
  WEvent.add_listener publish (fun x -> buzzFake s);
  () ;;
